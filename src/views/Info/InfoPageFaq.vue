<template>
    <v-container class="pa-5 mb-13 rounded-xl bg-text">
        ...
        the founder said that slavery in the chocolate industry has only gone <em>up</em>. A $50 billion-a-year industry, and nearly
        every company in it still uses literal slavery.
        </p>
        <p>
