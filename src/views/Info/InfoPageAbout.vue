<template>
    <v-container style="background-color:#FFDA0C; padding:20px; border-radius: 20px">
        ...
        that <em>The Definitely Not Murder Shop</em> is owned by <em>Murder Hut</em>? How can we make better
        ...
        bad guys." In general, you should not feel guilty for buying things you need from businesses that suck. While there are certainly
        companies you probably <em>shouldn't</em> buy from, this site is not here to make that decision for you; the goal is simply to
        give you the information you need to decide for yourself, or to make you say "woah! that tiny local company I've been supporting
        is actually owned by the biggest megacorporation in the world!? wack!"
        </p>
        <p>
        Only buying from "good" businesses is not a substitute for actively working to make the world better. Spending more than a
        few minutes searching here will make it immediately clear that trying to only support ethical businesses is a fruitless endeavour unless you
        ...
        <p>
        But, like, maybe don't buy stuff from Amazon if you can avoid it. It's not gonna stop Jeff Bezos from being unfathomably rich,
